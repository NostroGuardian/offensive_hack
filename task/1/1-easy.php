...
<section class="chat">
    <div class="chat_frame">
        <div class="chat_frame_inner">
            ...
            $all_messages = $connection->query('SELECT * FROM `task_1_easy`')->fetchAll(PDO::FETCH_ASSOC);
...
<div class="chat_input">
    ...
    if (isset($_POST['chat_btn'])) {
        ...
        if (!(trim($chat_message, $whitespaces))) {
            ...
            $query = 'INSERT INTO `task_1_easy` (username, message) VALUES (:chat_user, :chat_message)';
