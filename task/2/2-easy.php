...
<section class="chat">
    <div class="chat_frame">
        <div class="chat_frame_inner">
            ...
            $all_messages = $connection->query('SELECT * FROM `task_2_easy`')->fetchAll(PDO::FETCH_ASSOC);
    ...
    if (isset($_POST['chat_btn'])) {
        ...
        if (!(trim($chat_message, $whitespaces))) {
            ...
            $query = 'INSERT INTO `task_2_easy` (username, message) VALUES (:chat_user, :chat_message)';
